...
\newcommand{\FirmenLogoDeckblatt}{\fbox{\includegraphics[width=3cm]{images/SICK_Logo_Claim}}}
...
\include{input/abk}              % Abkürzungsverzeichnis
\newpage
...
\include{input/aufgabenstellung}
\include{input/grundlagen}
\include{input/konzept}
\include{input/implementierung}
\include{input/ergebnis}
\include{input/notizen}
